...
@AnalyzeClasses( packages = "com.lirium.nutrition",  importOptions = ImportOption.DoNotIncludeTests.class)
public class ArchitectureTest {
    ...
    static final ArchRule securityBeansShouldNotDependOnServiceLayer =
            noClasses()
                    ...
                    .and().haveSimpleNameEndingWith("Security")
    ...
    static final ArchRule serviceImplementationsShouldImplementService =
            classes()
                    ...
                    .should().implement(JavaClass.Predicates.simpleNameEndingWith("Service"));
