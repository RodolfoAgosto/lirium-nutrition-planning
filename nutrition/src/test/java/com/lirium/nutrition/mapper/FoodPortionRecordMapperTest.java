...
class FoodPortionRecordMapperTest {
  ...
  void shouldMapEntityToResponse() {
    ...
    Food food = Food.of("Rice", 350, 7, 78, 1, FoodCategory.CARB, Set.of(MealType.LUNCH));

    User user = new User("test@test.com", "123456", "Juan", "Perez", Role.PATIENT);
    ...
    FoodPortionRecordResponseDTO dto = FoodPortionRecordMapper.toResponse(portion);
  ...
  void shouldMapEntityToSummary() {
    ...
    FoodPortionRecordSummaryDTO dto = FoodPortionRecordMapper.toSummary(portion);
  ...
  void shouldMapCreateDtoToEntity() {
    ...
    FoodPortionRecord entity = FoodPortionRecordMapper.toEntity(dto, meal, food);
