...
class PlanMealMapperTest {
  ...
  void toResponse_shouldMapEntityToResponseDTO() {
    ...
    Food food = Food.of("Apple", 52, 1, 14, 0, FoodCategory.FRUIT, Set.of(MealType.BREAKFAST));
  ...
  void updateEntity_shouldNotThrowException() {
    ...
    PlanMealUpdateRequestDTO dto = new PlanMealUpdateRequestDTO("DINNER", List.of());

    assertDoesNotThrow(() -> PlanMealMapper.updateEntity(meal, dto));
