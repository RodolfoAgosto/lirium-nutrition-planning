...
class PlanFoodPortionMapperTest {
  ...
  void toResponse_shouldMapEntityToResponseDTO() {
    ...
    Food food = Food.of("Apple", 52, 0, 14, 0, FoodCategory.FRUIT, Set.of(MealType.BREAKFAST));
    ...
    PlanFoodPortion portion = PlanFoodPortion.of(meal, food, 150.0, MeasureUnit.GRAM);

    ReflectionTestUtils.setField(portion, "id", 10L);

    PlanFoodPortionResponseDTO dto = PlanFoodPortionMapper.toResponse(portion);
  ...
  void toSummary_shouldMapEntityToSummaryDTO() {
    ...
    PlanFoodPortionSummaryDTO dto = PlanFoodPortionMapper.toSummary(portion);
  ...
  void toEntity_shouldCreateEntityFromCreateRequest() {
    ...
    PlanFoodPortionCreateRequestDTO dto =
        new PlanFoodPortionCreateRequestDTO(1L, 2L, 150.0, MeasureUnit.GRAM);

    PlanFoodPortion entity = PlanFoodPortionMapper.toEntity(dto, meal, food);
  ...
  void toEntity_shouldCreateEntityFromFoodPortionAddRequest() {
    ...
    FoodPortionAddRequestDTO dto = new FoodPortionAddRequestDTO(2L, 200.0, MeasureUnit.GRAM);
