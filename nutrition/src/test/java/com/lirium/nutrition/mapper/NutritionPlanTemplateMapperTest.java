...
class NutritionPlanTemplateMapperTest {
  ...
  void shouldMapCreateDtoToEntity() {
    ...
    NutritionPlanTemplate entity = NutritionPlanTemplateMapper.toEntity(dto);
    ...
    assertThat(entity.getExcludedTags()).containsExactlyInAnyOrder(FoodTag.HONEY, FoodTag.NUTS);
  }
  ...
  void shouldMapCreateDtoWithNullTags() {
    ...
    NutritionPlanTemplateCreateRequestDTO dto =
        new NutritionPlanTemplateCreateRequestDTO(
            "Maintenance", "Standard template", GoalType.WEIGHT_LOSS, 30, 45, 25, null);
  ...
  void shouldMapEntityToResponse() {
    ...
    NutritionPlanTemplate entity =
        NutritionPlanTemplate.of(
            ...
            40,
            20,
            new HashSet<>(Set.of(FoodTag.HONEY, FoodTag.NUTS)));

    NutritionPlanTemplateResponseDTO dto = NutritionPlanTemplateMapper.toResponse(entity);
    ...
    assertThat(dto.excludedTags()).containsExactlyInAnyOrder(FoodTag.HONEY, FoodTag.NUTS);
  }
  ...
  void shouldMapEntityToSummary() {
    ...
    NutritionPlanTemplate entity =
        NutritionPlanTemplate.of(
            "Keto", "Low carb", GoalType.WEIGHT_LOSS, 30, 10, 60, new HashSet<>());

    NutritionPlanTemplateSummaryDTO dto = NutritionPlanTemplateMapper.toSummary(entity);
