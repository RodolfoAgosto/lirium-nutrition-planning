...
class FoodMapperTest {
  ...
  void shouldMapEntityToResponse() {
    ...
    Food food = Food.of("Milk", 60, 3, 5, 3, FoodCategory.DAIRY, Set.of(MealType.BREAKFAST));
  ...
  void shouldMapEntityToSummary() {
    ...
    Food food = Food.of("Apple", 52, 0, 14, 0, FoodCategory.FRUIT, Set.of());
  ...
  void shouldMapCreateDtoToEntity() {
    ...
    assertThat(entity.getSuitableFor()).containsExactlyInAnyOrder(MealType.LUNCH, MealType.DINNER);
    assertThat(entity.getFoodTags()).containsExactly(FoodTag.FISH);
  }
  ...
  void shouldMapCreateDtoWithoutTags() {
    ...
    FoodCreateRequestDTO dto =
        new FoodCreateRequestDTO(
            "Rice", 130, 3, 28, 1, FoodCategory.CARB, Set.of(MealType.LUNCH), null);
  ...
  void shouldUpdateEntity() {
    ...
    Food entity = Food.of("Milk", 60, 3, 5, 3, FoodCategory.DAIRY, Set.of(MealType.BREAKFAST));

    entity.addTag(FoodTag.LACTOSE);

    FoodUpdateRequestDTO dto =
        new FoodUpdateRequestDTO("Soy Milk", 45, 4, 2, 2, Set.of(FoodTag.SOY));
  ...
  void shouldNotUpdateNullFields() {
    ...
    Food entity = Food.of("Egg", 155, 13, 1, 11, FoodCategory.PROTEIN, Set.of(MealType.BREAKFAST));

    entity.addTag(FoodTag.EGG);

    FoodUpdateRequestDTO dto = new FoodUpdateRequestDTO(null, null, null, null, null, null);
