...
class PatientProfileMapperTest {
  ...
  void shouldMapToEntityCorrectly() {
    ...
    PatientProfileCreateRequestDTO dto =
        new PatientProfileCreateRequestDTO(
            1L,
            Sex.MALE,
    ...
    // when
    PatientProfile profile = PatientProfileMapper.toEntity(dto, user, restrictions);
  ...
  void shouldMapUpdateEntityCorrectly() {
    ...
    PatientProfileUpdateRequestDTO dto =
        new PatientProfileUpdateRequestDTO(
            Sex.FEMALE,
  ...
  void shouldMapToResponseCorrectly() throws Exception {
    ...
    // when
    PatientProfileResponseDTO dto = PatientProfileMapper.toResponse(profile);
