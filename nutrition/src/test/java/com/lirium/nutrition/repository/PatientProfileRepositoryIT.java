...
class PatientProfileRepositoryIT {

  @Autowired private PatientProfileRepository repository;
  ...
  void shouldFindByUser() {
    ...
    Optional<PatientProfile> result = repository.findByUser(user);
  ...
  void shouldFindBySex() {
    ...
    List<PatientProfile> result = repository.findBySex(Sex.FEMALE);
  ...
  void shouldFindByPrimaryGoal() {
    ...
    List<PatientProfile> result = repository.findByPrimaryGoal(GoalType.MUSCLE_GAIN);
  ...
  void shouldSearchPatients() {
    ...
    var result = repository.searchPatients("Juan", null, null, null);
  ...
  void shouldFindByUserIdFetchUser() {
    ...
    Optional<PatientProfile> result = repository.findByUserIdFetchUser(user.getId());
  ...
  void shouldFindByUserId() {
    ...
    Optional<PatientProfile> result = repository.findByUserId(user.getId());
  ...
  private User createUser() {
    ...
    User user = new User(email, UUID.randomUUID().toString(), "Juan", "Perez", Role.PATIENT);
  ...
  private PatientProfile createPatientNamed(String first, String last, String dni) {
  ...
  private PatientProfile createPatientWithGoal(String email) {
    ...
    User user = new User(email + UUID.randomUUID(), "123456", "Juan", "Perez", Role.PATIENT);
