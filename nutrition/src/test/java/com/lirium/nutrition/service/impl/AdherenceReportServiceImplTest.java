...
class AdherenceReportServiceImplTest {
    ...
    void setUp() {
        ...
        lenient().when(nutritionPlanRepository.findFirstByPatientProfile_IdOrderByStartDateAsc(any()))
    ...
    void shouldThrowExceptionWhenPatientDoesNotExist() {
        ...
        // When & Then
        assertThrows(ResourceNotFoundException.class, () -> service.getAdherence(patientId, START, END));
    }
    ...
    void shouldThrowExceptionWhenFromIsBeforeEarliestStartDate() {
        ...
        // When & Then
        assertThrows(IllegalArgumentException.class, () -> service.getAdherence(patientId, fromPriorToPlan, END));
    }
