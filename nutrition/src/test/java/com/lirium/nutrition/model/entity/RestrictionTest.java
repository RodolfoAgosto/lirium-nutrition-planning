...
class RestrictionTest {
  ...
  void shouldCreateRestriction() {
    ...
    assertThat(restriction.getCode()).isEqualTo("GLUTEN");

    assertThat(restriction.getName()).isEqualTo("Gluten intolerance");

    assertThat(restriction.getCategory()).isEqualTo(RestrictionCategory.INTOLERANCES);

    assertThat(restriction.getExcludedTags()).containsExactly(FoodTag.GLUTEN);
  }
  ...
  void shouldInitializeExcludedTags() {
    ...
    assertThat(restriction.getExcludedTags()).isNotNull();

    assertThat(restriction.getExcludedTags()).isEmpty();
  }
  ...
  void shouldAllowMultipleExcludedTags() {
    ...
    Restriction restriction =
        Restriction.builder()
            ...
            .excludedTags(Set.of(FoodTag.MEAT, FoodTag.NUTS))
            .build();

    assertThat(restriction.getExcludedTags()).containsExactlyInAnyOrder(FoodTag.MEAT, FoodTag.NUTS);
  }
