...
class DailyRecordTest {
  ...
  void setUp() {
    ...
    dailyRecord = DailyRecord.of(patient, LocalDate.of(2026, 7, 10));
  }
  ...
  void shouldCreateDailyRecord() {
    ...
    assertEquals(LocalDate.of(2026, 7, 10), dailyRecord.getDate());
  }
  ...
  void shouldThrowWhenPatientIsNull() {
    ...
    assertThrows(NullPointerException.class, () -> DailyRecord.of(null, LocalDate.now()));
  }
  ...
  void shouldThrowWhenDateIsNull() {
    ...
    assertThrows(NullPointerException.class, () -> DailyRecord.of(patient, null));
  }
  ...
  void shouldThrowWhenAddingNullMeal() {
    ...
    assertThrows(NullPointerException.class, () -> dailyRecord.addMeal(null));
  }
  ...
  void shouldReturnUnmodifiableMeals() {
    ...
    assertThrows(
        UnsupportedOperationException.class, () -> dailyRecord.getMeals().add(new MealRecord()));
  }
}
