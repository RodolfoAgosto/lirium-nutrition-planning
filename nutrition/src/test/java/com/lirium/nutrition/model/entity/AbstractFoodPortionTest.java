...
class AbstractFoodPortionTest {
  ...
  void setUp() {
    ...
    chicken =
        Food.of("Chicken", 200, 30, 10, 20, FoodCategory.PROTEIN, EnumSet.allOf(MealType.class));
  }
  ...
  void shouldThrowWhenFoodIsNull() {
    ...
    NullPointerException ex =
        assertThrows(
            NullPointerException.class, () -> new TestFoodPortion(null, 100.0, MeasureUnit.GRAM));
  ...
  void shouldThrowWhenQuantityIsNull() {
    ...
    NullPointerException ex =
        assertThrows(
            NullPointerException.class, () -> new TestFoodPortion(chicken, null, MeasureUnit.GRAM));
  ...
  void shouldThrowWhenUnitIsNull() {
    ...
    NullPointerException ex =
        assertThrows(NullPointerException.class, () -> new TestFoodPortion(chicken, 100.0, null));
