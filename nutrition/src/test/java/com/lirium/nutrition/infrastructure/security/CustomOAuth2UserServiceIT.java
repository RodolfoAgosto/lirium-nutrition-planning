...
class CustomOAuth2UserServiceIT extends AbstractIntegrationTest {
  ...
  @Autowired private CustomOAuth2UserService service;
    ...
    OAuth2User user =
        new OAuth2User() {
          ...
          public Map<String, Object> getAttributes() {
            return Map.of("email_verified", true);
          }
  ...
  void shouldRejectOAuthUserWithUnverifiedEmail() {
    ...
    OAuth2User user =
        new DefaultOAuth2User(
            null, Map.of("email", "test@test.com", "email_verified", false), "email");
  ...
  void shouldAcceptOAuthUserWithVerifiedEmail() {
    ...
    OAuth2User user =
        new DefaultOAuth2User(
            null, Map.of("email", "test@test.com", "email_verified", true), "email");
