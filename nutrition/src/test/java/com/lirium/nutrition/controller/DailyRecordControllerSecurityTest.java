...
public class DailyRecordControllerSecurityTest {
  ...
  @MockBean private PatientSecurity patientSecurity;

  @MockBean private UserRepository userRepository;

  @MockBean private PatientProfileRepository patientProfileRepository;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
      return http.csrf(csrf -> csrf.disable())
          .authorizeHttpRequests(
              auth -> auth.anyRequest().permitAll()) // Permitimos el paso HTTP plano
          .build();
    }
  }
