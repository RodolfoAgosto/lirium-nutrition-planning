...
class UserControllerTest {
  ...
  void shouldRegisterUserSuccessfully() throws Exception {
    ...
    UserResponseDTO responseDTO =
        new UserResponseDTO(
            1L, "test@mail.com", "John", "Doe", LocalDate.of(2000, 1, 1), "12345678", false, true);
  ...
  void shouldFindById() throws Exception {
    ...
    UserResponseDTO responseDTO =
        new UserResponseDTO(
            1L, "test@mail.com", "John", "Doe", LocalDate.of(2000, 1, 1), "12345678", true, true);
  ...
  void shouldUpdateUser() throws Exception {
    ...
    UserUpdateRequestDTO request =
        new UserUpdateRequestDTO("John", "Updated", LocalDate.of(2000, 1, 1));
    UserResponseDTO responseDTO =
        new UserResponseDTO(
            1L,
            "test@mail.com",
    ...
    when(userService.updateBasicInfo(eq(1L), any())).thenReturn(responseDTO);
  ...
  void shouldValidateEmailSuccessfully() throws Exception {
    ...
    mockMvc
        .perform(patch("/api/users/1/validate-email"))
        .andExpect(status().isOk())
