...
/**
 * Represents the activity level of a patient. `label` is used for display in UI while enum name is
 * used internally.
 */
public enum ActivityLevel {
  ...
  ActivityLevel(
      double factor, double maleProtein, double femaleProtein, double maleFat, double femaleFat) {
    this.factor = factor;
