...
/**
 * Represents a patient's profile with personal, anthropometric, and medical data. Contains sex,
 * activity level, weight, height, medical notes, dietary restrictions, physiological conditions,
 * and primary nutrition goal. Acts as the aggregate root for patient-specific nutrition
 * information.
 */
@Entity
@Getter
...
public class PatientProfile extends Auditable {
  ...
  @Enumerated(EnumType.STRING)
  @CollectionTable(
      name = "patient_profile_physiological_conditions",
      joinColumns = @JoinColumn(name = "patient_profile_id"))
  ...
  public void updateNutritionProfile(
      Height height, Weight weight, ActivityLevel activityLevel, GoalType goal) {
