...
/**
 * Food catalog entity with nutritional values per 100g. Values are validated on creation and tags
 * are stored as value types using an ElementCollection.
 */
@Entity
@Table(name = "foods")
@Getter
...
public class Food extends DateAuditable {
  ...
  @CollectionTable(name = "food_suitable_for", joinColumns = @JoinColumn(name = "food_id"))
  @Enumerated(EnumType.STRING)
  ...
  public static Food of(
    ...
    Food food =
        of(name, caloriesPer100g, proteinPer100g, carbsPer100g, fatPer100g, category, suitableFor);
  ...
  public void changeServingLimits(Double minGrams, Double maxGrams) {
    ...
    if (minGrams != null && maxGrams != null && minGrams > maxGrams) {
      throw new IllegalArgumentException(
          "Min serving grams cannot be greater than max serving grams");
    }
