...
/**
 * Represents a meal within a DailyPlan, e.g., breakfast, lunch, or dinner. Each PlanMeal contains a
 * list of PlanFoodPortion instances, forming the meal's composition. This entity is part of the
 * DailyPlan aggregate, and food portions should be added via `addFoodPortion` to maintain
 * consistency.
 */
@Entity
@Getter
...
public class PlanMeal extends DateAuditable {
  ...
  @Id
  @SequenceGenerator(name = "plan_meal_seq", sequenceName = "plan_meal_seq", allocationSize = 1)
