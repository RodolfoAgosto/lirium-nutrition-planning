...
/**
 * Represents a dietary restriction, e.g., gluten-free, low-sodium. Code is unique and used as a
 * natural identifier.
 */
@Entity
@Getter
...
public class Restriction extends DateAuditable {
  ...
  @Id
  @SequenceGenerator(name = "restriction_seq", sequenceName = "restriction_seq", allocationSize = 1)
