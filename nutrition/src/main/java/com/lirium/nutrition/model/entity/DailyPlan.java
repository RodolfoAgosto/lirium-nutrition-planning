...
/**
 * Represents a day within a NutritionPlan aggregate. A DailyPlan groups the meals planned for a
 * specific DayOfWeek and belongs to exactly one NutritionPlan. Encapsulation rules: - Meals are
 * managed through add/remove methods only. - Collections are exposed as read-only views. - A
 * DailyPlan cannot exist without a NutritionPlan.
 */
@Entity
