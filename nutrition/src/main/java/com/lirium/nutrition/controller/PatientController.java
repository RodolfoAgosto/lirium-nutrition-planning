...
@Tag(name = "Patients", description = "Endpoints for searching, retrieving, and updating patient profiles")
    ...
    @ApiResponses(value = {
            @ApiResponse(
                    ...
                    content = @Content(
                            ...
                            array = @ArraySchema(schema = @Schema(implementation = PatientSummaryDTO.class))
                    )
            )
    })
