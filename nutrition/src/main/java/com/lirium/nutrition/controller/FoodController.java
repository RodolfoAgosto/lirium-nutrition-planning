...
@Tag(
    name = "Food Catalog",
    description = "Endpoints for generating, retrieving, and managing food catalog.")
@Validated
public class FoodController {
  ...
  public FoodResponseDTO getFoodById(
      @Parameter(description = "Unique identifier of the food", example = "1")
          @PathVariable
  ...
  @Operation(
      ...
      description =
          "Creates a new food in the nutrition catalog. Only administrators can perform this operation.")
  @ApiResponses({
  ...
  @Operation(
      ...
      description =
          "Deletes a food from the nutrition catalog. Administrators and nutritionists can perform this operation.")
  @ApiResponses({
