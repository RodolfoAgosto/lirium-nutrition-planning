...
@Tag(
    name = "Plan Meals",
    description = "Endpoints for managing meal structures and portions within nutrition plan days")
...
public class PlanMealController {
  ...
  @Operation(
      ...
      description =
          "Retrieves full details of a specific plan meal. Accessible by ADMIN, NUTRITIONIST, or the owner PATIENT.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  @PreAuthorize(
      "hasAnyRole('ADMIN','NUTRITIONIST') or @planMealSecurity.isOwner(#id, authentication)")
  @GetMapping("/{id}")
  ...
  @Operation(
      ...
      description =
          "Retrieves all planned meals assigned to a specific plan day. Accessible by ADMIN, NUTRITIONIST, or the owner PATIENT.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
            ...
            content =
                @Content(
                    mediaType = "application/json",
                    array =
                        @ArraySchema(schema = @Schema(implementation = PlanMealSummaryDTO.class))))
      })
  @PreAuthorize(
      "hasAnyRole('ADMIN','NUTRITIONIST') or @planMealSecurity.isPlanDayOwner(#planDayId, authentication)")
  @GetMapping("/day/{planDayId}")
  public List<PlanMealSummaryDTO> getByPlanDay(
      @PathVariable("planDayId") @Positive Long planDayId) {
  ...
  @Operation(
      ...
      description =
          "Deletes an existing plan meal by its ID. Restricted to ADMIN and NUTRITIONIST users.")
  @ApiResponses(
      value = {@ApiResponse(responseCode = "204", description = "Plan meal deleted successfully")})
  @DeleteMapping("/{id}")
  ...
  public ResponseEntity<PlanMealResponseDTO> addPortion(
      @PathVariable @Positive Long mealId, @Valid @RequestBody FoodPortionAddRequestDTO dto) {
  ...
  @Operation(
      ...
      description =
          "Updates the quantity of a specific food portion within a plan meal. Restricted to ADMIN and NUTRITIONIST users.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
