...
@Tag(
    name = "Plan Food Portions",
    description = "Endpoints for retrieving planned food portion details within plan meals")
...
public class PlanFoodPortionController {
  ...
  @Operation(
      ...
      description =
          "Retrieves all planned food portions assigned to a specific plan meal. Accessible by ADMIN, NUTRITIONIST, or the owner PATIENT.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  @PreAuthorize(
      "hasAnyRole('ADMIN','NUTRITIONIST') or @planFoodPortionSecurity.isMealOwner(#planMealId, authentication)")
  public ResponseEntity<List<PlanFoodPortionResponseDTO>> getByMeal(
      @P("planMealId") @PathVariable @Positive Long planMealId) {
  ...
  @Operation(
      ...
      description =
          "Retrieves details of a specific planned food portion. Accessible by ADMIN, NUTRITIONIST, or the owner PATIENT.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  @GetMapping("/{id}")
  @PreAuthorize(
      "hasAnyRole('ADMIN','NUTRITIONIST') or @planFoodPortionSecurity.isPortionOwner(#id, authentication)")
