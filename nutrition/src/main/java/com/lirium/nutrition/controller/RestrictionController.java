...
@Tag(
    ...
    description =
        "Endpoints for managing global dietary restrictions catalog (dietary, intolerances, pathological)")
@Validated
public class RestrictionController {
  ...
  @Operation(
      ...
      description =
          "Retrieves a summary list of all dietary restrictions registered in the catalog.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  @Operation(
      ...
      description =
          "Creates a new entry in the global dietary restrictions catalog. Restricted to ADMIN users.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "201",
  ...
  public ResponseEntity<RestrictionSummaryDTO> create(
  ...
  @Operation(
      ...
      description =
          "Retrieves full detailed information of a specific dietary restriction by its ID.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  @Operation(
      ...
      description =
          "Updates an existing dietary restriction in the catalog. Restricted to ADMIN users.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
