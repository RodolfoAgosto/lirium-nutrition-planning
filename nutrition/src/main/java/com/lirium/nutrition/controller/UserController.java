...
public class UserController {
    ...
    @PostMapping("/patient")
    public ResponseEntity<UserResponseDTO> registerPatient(@Valid @RequestBody CreatePatientRequestDTO request) {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(
                    responseCode = "403",
                    description = "Forbidden. Lacks required permissions (requires ADMIN or NUTRITIONIST role).",
                    content = @Content
            )
    })
    @GetMapping
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(
                    responseCode = "403",
                    description = "Forbidden. User can only validate their own email unless they have 'user.write' authority.",
                    content = @Content
            ),
            @ApiResponse(
                    responseCode = "404",
