...
public class NutritionPlanAssemblerImpl implements NutritionPlanAssembler {
  ...
  @Override
  public NutritionPlan assemble(
      PatientProfile patient, Calories calories, MacroDistribution macros) {
  ...
  public NutritionPlan assemble(
    ...
    log.info(
        "Assembling nutrition plan patientId={} calories={} protein={} carbs={} fat={}",
        patient.getId(),
        calories.amount(),
        macros.proteinGrams(),
        macros.carbGrams(),
