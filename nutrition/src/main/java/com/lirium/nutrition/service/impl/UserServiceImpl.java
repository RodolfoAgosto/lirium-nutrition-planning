...
public class UserServiceImpl implements UserService {
  ...
  public UserServiceImpl(
      UserRepository userRepository, UserMapper userMapper, BCryptPasswordEncoder passwordEncoder) {
  ...
  public UserResponseDTO registerUser(CreateUserRequestDTO request) {
    ...
    log.info(
        "User registered successfully id={} email={}", savedUser.getId(), savedUser.getEmail());
  ...
  public UserResponseDTO registerPatient(CreatePatientRequestDTO request) {
    ...
    log.info(
        "Patient registered successfully id={} email={}", savedUser.getId(), savedUser.getEmail());
