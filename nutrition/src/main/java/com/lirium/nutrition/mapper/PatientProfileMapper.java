...
public final class PatientProfileMapper {
  ...
  public static PatientProfile toEntity(
      PatientProfileCreateRequestDTO dto, User user, Set<Restriction> restrictions) {
  ...
  public static void updateEntity(
      PatientProfile entity, PatientProfileUpdateRequestDTO dto, Set<Restriction> restrictions) {
  ...
  public static PatientProfileResponseDTO toResponse(PatientProfile entity) {
    ...
    Set<String> restrictionNames =
        entity.getRestrictions().stream().map(r -> r.getName()).collect(Collectors.toSet());
  ...
  public static PatientProfileSummaryDTO toSummary(PatientProfile entity) {
    ...
    return new PatientProfileSummaryDTO(
        entity.getId(), entity.getUser().getId(), entity.getPrimaryGoal());
  }
}
