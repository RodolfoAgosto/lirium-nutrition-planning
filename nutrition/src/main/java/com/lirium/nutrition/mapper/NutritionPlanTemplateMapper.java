...
public class NutritionPlanTemplateMapper {
  ...
  /* === CREATE === */
  public static NutritionPlanTemplate toEntity(NutritionPlanTemplateCreateRequestDTO dto) {
    ...
    return NutritionPlanTemplate.of(
        ...
        dto.carbPercentage(),
        dto.fatPercentage(),
        dto.excludedTags() != null ? new HashSet<>(dto.excludedTags()) : new HashSet<>());
  }

  /* === RESPONSE === */
  public static NutritionPlanTemplateResponseDTO toResponse(NutritionPlanTemplate entity) {
  ...
  /* === SUMMARY === */
  public static NutritionPlanTemplateSummaryDTO toSummary(NutritionPlanTemplate entity) {

    return new NutritionPlanTemplateSummaryDTO(
        entity.getId(), entity.getName(), entity.getTargetGoal());
  }
}
