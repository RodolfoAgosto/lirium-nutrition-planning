...
public class FoodDataLoader implements CommandLineRunner {
    ...
    foodRepository.saveAll(
        List.of(
            ...
            Food.of(
                ...
                Set.of(MealType.LUNCH, MealType.DINNER)),
            Food.of(
                "Tofu", 76, 8, 2, 5, FoodCategory.PROTEIN, Set.of(MealType.LUNCH, MealType.DINNER)),
            ...
            Food.of("Oatmeal", 389, 17, 66, 7, FoodCategory.CARB, Set.of(MealType.BREAKFAST)),
            Food.of(
                "Brown Rice",
                216,
                5,
            ...
            Food.of(
                ...
                FoodCategory.FAT,
                Set.of(MealType.BREAKFAST, MealType.LUNCH)),
            Food.of("Mixed Nuts", 607, 20, 21, 54, FoodCategory.FAT, Set.of(MealType.SNACK)),
            Food.of(
                "Peanut Butter",
                588,
                25,
  ...
  private void applyFoodTags(FoodRepository repo) {
    ...
    repo.findByName("Chicken Breast")
        .ifPresent(
            f -> {
              f.addTag(FoodTag.MEAT);
              repo.save(f);
            });

    repo.findByName("Salmon")
        .ifPresent(
            f -> {
              f.addTag(FoodTag.FISH);
              repo.save(f);
            });

    repo.findByName("Ground Beef")
        .ifPresent(
            f -> {
              f.addTag(FoodTag.MEAT);
              repo.save(f);
    ...
    repo.findByName("Scrambled Eggs")
        .ifPresent(
            f -> {
              f.addTag(FoodTag.EGG);
              repo.save(f);
            });

    repo.findByName("Whole Milk Yogurt")
        .ifPresent(
            f -> {
              f.addTag(FoodTag.LACTOSE);
              repo.save(f);
            });

    repo.findByName("Cottage Cheese")
        .ifPresent(
            f -> {
              f.addTag(FoodTag.LACTOSE);
              repo.save(f);
    ...
    repo.findByName("Whole Wheat Pasta")
        .ifPresent(
            f -> {
              f.addTag(FoodTag.GLUTEN);
              repo.save(f);
    ...
    repo.findByName("Whole Grain Bread")
        .ifPresent(
            f -> {
              f.addTag(FoodTag.GLUTEN);
              repo.save(f);
    ...
    repo.findByName("Tofu")
        .ifPresent(
            f -> {
              f.addTag(FoodTag.SOY);
              repo.save(f);
            });

    repo.findByName("Soy Milk")
        .ifPresent(
            f -> {
              f.addTag(FoodTag.SOY);
              repo.save(f);
    ...
    repo.findByName("Mixed Nuts")
        .ifPresent(
            f -> {
              f.addTag(FoodTag.NUTS);
              repo.save(f);
            });

    repo.findByName("Peanut Butter")
        .ifPresent(
            f -> {
              f.addTag(FoodTag.NUTS);
              repo.save(f);
