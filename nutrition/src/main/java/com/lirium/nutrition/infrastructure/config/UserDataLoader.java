...
public class UserDataLoader implements CommandLineRunner {
  ...
  public void run(String... args) {
    ...
    User u1 =
        new User("ana@test.com", passwordEncoder.encode("1234"), "Ana", "Lopez", Role.PATIENT);
    u1.setBirthDate(LocalDate.of(1990, 5, 10));
    u1.setDni("30111222");

    User u2 =
        new User("juan@test.com", passwordEncoder.encode("1234"), "Juan", "Perez", Role.PATIENT);
    u2.setBirthDate(LocalDate.of(1985, 3, 22));
    u2.setDni("28999111");

    User u3 =
        new User("maria@test.com", passwordEncoder.encode("1234"), "Maria", "Gomez", Role.PATIENT);
    u3.setBirthDate(LocalDate.of(2000, 1, 15));
    u3.setDni("40123456");

    User u4 =
        new User("admin@lirium.com", passwordEncoder.encode("1234"), "Admin", "Lirium", Role.ADMIN);
