...
public interface DailyRecordRepository extends JpaRepository<DailyRecord, Long> {
  ...
  @Query(
      "SELECT DISTINCT dr FROM DailyRecord dr LEFT JOIN FETCH dr.meals WHERE dr.patient.id = :patientId AND dr.date BETWEEN :from AND :to")
  List<DailyRecord> findByPatient_IdAndDateBetweenWithMeals(
