...
public record NutritionPlanTemplateCreateRequestDTO(
        ...
        @Schema(description = "Detailed description of the template", example = "Balanced template with 40% protein split designed for cutting.")
        ...
        @Schema(description = "Food tags to automatically exclude from this template", example = "[\"GLUTEN\", \"LACTOSE\"]")
